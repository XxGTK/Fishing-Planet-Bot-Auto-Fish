...
Global $status = 0, $fish = 0, $start = 0, $ct = 0 ,$st = 0, $pt = 0 , $cp,$twitch = 0
global $color1=0xE3E3E3, $color2=0xB9BABA, $color3=0xC37F41 , $color4 = 0xFFFFFF, $color5 = 0xF7F7F7, $color6 = 0xFF0000 , $color7 = 0x7ED322, $color8 = 0xFFC300 ,$color9=0x4DA80D,$color10=0xDC8F49
Global $x1=1254,$y1=331, $x2=1260,$y2=676, $x3=739,$y3=666, $x4=284,$y4=638, $x5=324,$y5=654, $x6 = 516, $y6 = 433, $x7= 213, $y7 = 198, $x8 = 327 , $y8 = 108, $x9 = 62,$y9 = 128,$x10=615,$y10=519,$x11=504
...
$Label4 = GUICtrlCreateLabel("Spin/Tw Time:", 200, 124, 84, 24)
GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
...
$twchk = GUICtrlCreateCheckbox("Twitch?", 24, 160, 97, 17)
GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
...
WinActivate("FishingPlanet","")
	...
	$twitch = GuiCtrlRead($twchk)
if winactive("FishingPlanet","") then
#проверка в воде ли приманка
		PixelSearch($x2-2,$y2-2,$x2+2,$y2+2,$color2,10)
		if Not @error then
...
sleep(500)
#поймали рыбу?
		PixelSearch($x3-50,$y3-20,$x3+50,$y3+20,$color3,3)
			if Not @error then
				sleep(4000)
...
MouseUP($MOUSE_CLICK_LEFT)
sleep($ct)
If GUICtrlRead($twchk) = $GUI_CHECKED Then
MouseDown($MOUSE_CLICK_LEFT)
endif
endfunc

Func _provodka()
Pixelsearch(1270,615,1280,620,0x1B40C6,5,1)
If GUICtrlRead($twchk) = $GUI_UNCHECKED Then
GuiCtrlSetData($statusread,"Stop and Go")
MouseDown($MOUSE_CLICK_LEFT)
sleep($st)
MouseUP($MOUSE_CLICK_LEFT)
sleep($pt)
EndIf
If GUICtrlRead($twchk) = $GUI_CHECKED Then
GuiCtrlSetData($statusread,"Twitching")
